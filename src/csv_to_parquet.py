...
## @type: DataSource
## @args: [database = "feuvert_db", table_name = "raw_feuvert_fakedata", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "feuvert_db", table_name = "raw_feuvert_fakedata", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
applymapping1 = ApplyMapping.apply(frame = datasource0, mappings = [("id_shop","int","id_shop","int"),("country","string","country","string"),("date","string","date","string"),("id_client","int","id_client","int"),("nb_article","int","nb_article","int"),("price","string","price","string")], transformation_ctx = "applymapping1")
## @type: ResolveChoice
